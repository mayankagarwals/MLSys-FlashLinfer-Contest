# flashinfer_wrapper_123ca6

## Summary

- Source JSON: `baseline/gdn/gdn_prefill_qk4_v8_d128_k_last/flashinfer_wrapper_123ca6.json`
- Definition: `gdn_prefill_qk4_v8_d128_k_last`
- Author: `flashinfer`
- Description: Solution using FlashInfer SM100 CuTile chunk_gated_delta_rule for GDN prefill (qk4_v8_d128, k-last state layout) on NVIDIA B200 (Blackwell).
