# chunk_v8b: based on chunk_v7b (CUDA tcgen05 H kernel path for high-N workloads)
#
# Changes from v7b:
...
from .chunk_v8c import (
    merge_16x16_to_64x64_inverse_kernel_v2,
)

chunk_fwd_kernel_o = _chunk_v7.chunk_fwd_kernel_o

# Build own CUDA module with cuda_h_v2.cu (tcgen05 H) + cuda_kkt_v1b.cu (with_meta)
