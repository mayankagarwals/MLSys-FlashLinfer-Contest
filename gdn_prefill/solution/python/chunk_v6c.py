# chunk_v6c: chunk_v6 + v6b optimizations (fused o-kernel, no .item() sync)
# Imports unchanged kernels from triton_v4; merge/inverse and o-kernel are new.
# Mainly addressed comments on chunk_v6.
