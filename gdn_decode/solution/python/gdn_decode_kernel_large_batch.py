...
@cute.kernel
def gdn_decode_kernel_large_batch_pretranspose(
...
@cute.jit
def run_gdn_decode_kernel_large_batch_pretranspose(
    ...
    gdn_decode_kernel_large_batch_pretranspose(
        tiled_copy_load,
        h0_source,
        smem_layout_staged,
        vec_size,
...
def run(q, k, v, state, A_log, a, dt_bias, b, scale):
    ...
    if cache_key not in kernel_cache:
        ...
        compiled = cute.compile(
            run_gdn_decode_kernel_large_batch_pretranspose,
            h0_source_tensor,
            A_log_tensor,
            a_tensor,
            dt_bias_tensor,
